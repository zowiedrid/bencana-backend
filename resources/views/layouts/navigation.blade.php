        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('daerah.index')" :active="request()->routeIs('daerah.*')">
                        {{ __('Daerah') }}
                    </x-nav-link>
                    <x-nav-link :href="route('distribusi.index')" :active="request()->routeIs('distribusi.*')">
                        {{ __('Distribusi') }}
                    </x-nav-link>
                    <x-nav-link :href="route('kebutuhan.index')" :active="request()->routeIs('kebutuhan.*')">
                        {{ __('Kebutuhan') }}
                    </x-nav-link>
                    <x-nav-link :href="route('posko.index')" :active="request()->routeIs('posko.*')">
                        {{ __('Posko') }}
                    </x-nav-link>
                </div>
            </div>
